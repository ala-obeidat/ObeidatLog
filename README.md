...
3. **Unblocked:** by using [Blocking Collection](https://docs.microsoft.com/en-us/dotnet/api/system.collections.concurrent.blockingcollection-1?view=netframework-4.7.2) we get rid of block text file to handle multiple write at the same time.
